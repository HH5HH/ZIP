(function (root, factory) {
  ...
  const colors = [
    ...
    { id: "pink", name: "Pink", hex: "#FF94DB", spectrumToken: "spectrum-pink-500", recommendedForeground: "#111111", notes: "Playful high-visibility accent" },
    ...
    { id: "celery", name: "Celery", hex: "#81E43A", spectrumToken: "spectrum-celery-400", recommendedForeground: "#111111", notes: "Fresh high-energy green accent" },
  ...
  const groups = [
    ...
    { id: "pinks-magentas", name: "Pinks & Magentas", colorIds: ["pink", "fuchsia", "magenta"] },
    { id: "reds", name: "Reds", colorIds: ["petrus-red", "carmine"] },
    { id: "oranges-ambers", name: "Oranges & Ambers", colorIds: ["pumpkin", "amber", "sunflower"] },
    { id: "greens", name: "Greens", colorIds: ["chartreuse", "celery", "emerald", "cyan"] },
